...
var test = function (_testFunction, withMime) {
    ...
    var _test = function (ext, name, _text) {
        it("will " + ext + " files", function (done) {
            ...
            testFunction(withMime ? mime.getType(docPath) : docPath, textBuff, function (error, text) {
    ...
    _test("html", "test.html", " This is a long string of text that should get extracted with new lines inserted");
    ...
    _test("odt", "odt.odt", "This is an ODT THIS IS A HEADING More ODT");

    _test("potx", "potx.potx", "This is a potx template Yep, a potx I had no idea These were even a thing ");
    ...
    _test("odp", "odp.odp", "This is a title This is a slide's text This is a 2nd page And a 2nd page's content");

...
describe("fromUrl tests", function () {
    ...
    test("xlsx", "pi.xlsx", "This is the value of PI:,3.141592 ");

    test("pdf", "pdf.pdf", "This is a test. Please ignore.");
    ...
    test("text/*", "txt.txt", "This is a plain old text file.");
    ...
    test("odt", "odt.odt", "This is an ODT THIS IS A HEADING More ODT");

    test("potx", "potx.potx", "This is a potx template Yep, a potx I had no idea These were even a thing ");
    ...
    test("odp", "odp.odp", "This is a title This is a slide's text This is a 2nd page And a 2nd page's content");

    test("otp", "otp.otp", "This is a template title Template page text 2nd prezo text");
});
